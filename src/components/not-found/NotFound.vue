<template>
    <div class="not_found container d-flex justify-content-center mt-1 p-4">
      <!-- <img
        src="https://avatars.mds.yandex.net/i?id=f7b15f54d31c0ae3872cf818a1dac11bab21ddb7-6674535-images-thumbs&n=13"
        alt="image"
        class="w-50 img img-thumbnail notFoundImage"
      /> -->
      <div>
